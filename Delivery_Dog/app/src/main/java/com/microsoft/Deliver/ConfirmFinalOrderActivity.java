...
public class ConfirmFinalOrderActivity extends AppCompatActivity {
    ...
    private void ConfirmOrder() {
        ...
        final DatabaseReference ordersRef= FirebaseDatabase.getInstance("https://deliver-5bb5b-default-rtdb.firebaseio.com/").getReference()
                .child("Orders")
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()){
                                        ...
                                        Intent intent = new Intent(ConfirmFinalOrderActivity.this,CompleteActivity.class);
