...
public class SettinsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageProfilePrictureRef = FirebaseStorage.getInstance("gs://deliver-5bb5b.appspot.com/").getReference().child("Profile pictures");
    ...
    private void updateOnlyUserInfo() {
        DatabaseReference ref = FirebaseDatabase.getInstance("https://deliver-5bb5b-default-rtdb.firebaseio.com/").getReference().child("Users");
    ...
    private void uploadImage() {
        final ProgressDialog progressDialog = new ProgressDialog(this, R.style.alert);
    ...
    {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance("https://deliver-5bb5b-default-rtdb.firebaseio.com/").getReference().child("Users").child(Prevalent.currentOnlineUser.getPhone());
