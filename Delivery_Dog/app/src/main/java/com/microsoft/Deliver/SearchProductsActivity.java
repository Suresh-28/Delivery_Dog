...
public class SearchProductsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchBtn = findViewById(R.id.imageView12);
    ...
    protected void onStart() {
        super.onStart();
        DatabaseReference reference = FirebaseDatabase.getInstance("https://deliver-5bb5b-default-rtdb.firebaseio.com/").getReference().child("Products");
